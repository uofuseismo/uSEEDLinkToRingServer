#ifndef USEED_LINK_TO_RING_SERVER_STREAM_IDENTIFIER_HPP
#define USEED_LINK_TO_RING_SERVER_STREAM_IDENTIFIER_HPP
#include <string_view>
#include <string>
#include <memory>
...
[[nodiscard]] std::string toDataLinkIdentifier(const StreamIdentifier &identifier);
