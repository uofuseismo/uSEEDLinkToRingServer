...
seedLinkToRingServer is intended to import and monitor the import of seismic data from an external aggregation node.  To do this, seedLinkToRingServer imports seismic packets from a data source via SEEDLink then forwards those packets to local RingServer via DataLink.  To faciliate our transition to MiniSEED3, packets can be forwarded as MiniSEED2 or MiniSEED3.
